...
export function createMcpServer(deps) {
    const server = new McpServer({ name: 'azure-devops-hours', version: '1.0.0' }, {
        instructions: 'Lança horas em work items do Azure DevOps. Para vários itens use logBatchHours; para um só, logWorkItemHours. ' +
